    ...
    <div className="p-4 md:p-8 space-y-5 md:space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-5">
        ...
        <div className="glass-card rounded-xl p-4 md:p-6 flex flex-col gap-2">
          ...
          <div className="flex items-end justify-between gap-2">
            <span className="text-3xl md:text-4xl font-black text-[var(--color-text-primary)]">24</span>
        ...
        <div className="glass-card rounded-xl p-4 md:p-6 flex flex-col gap-2 border-l-4 border-[var(--color-error)]">
          ...
          <div className="flex items-end justify-between gap-2">
            <span className="text-3xl md:text-4xl font-black text-[var(--color-error)]">03</span>
        ...
        {/* Card 3 */}
        <div className="glass-card rounded-xl p-4 md:p-6 flex flex-col gap-2 border-l-4 border-[var(--color-success)] col-span-2 md:col-span-1">
          <span className="text-[10px] text-[var(--color-text-muted)] uppercase tracking-widest font-bold">SLA phản hồi</span>
          <div className="flex items-end justify-between gap-2">
            <span className="text-3xl md:text-4xl font-black text-[var(--color-text-primary)]">1m 45s</span>
            <span className="text-[var(--color-success)] bg-[var(--color-success-subtle)] text-[9px] px-2 py-1 rounded-full font-bold border border-[var(--color-success)]/30">
              Đạt chuẩn
            </span>
          </div>
        </div>
      ...
      <div className="glass-card rounded-xl p-3 md:p-4">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-3">
          <select className="col-span-2 lg:col-span-1 w-full select-app border border-[var(--color-border)] rounded-xl text-xs md:text-sm py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-[var(--color-brand)]/20 font-medium">
            <option>Workspace: Highlands Coffee</option>
            <option>Phúc Long Coffee &amp; Tea</option>
            <option>The Coffee House</option>
          </select>
          <select className="w-full select-app border border-[var(--color-border)] rounded-xl text-xs md:text-sm py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-[var(--color-brand)]/20 font-medium">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
              <div className="space-y-2 flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="bg-[var(--color-error)] text-white text-[9px] font-black px-2.5 py-1 rounded-lg uppercase tracking-widest">
                    🚨 CRITICAL
                  </span>
                  <span className="text-sm font-bold text-[var(--color-text-primary)]">Highlands Coffee</span>
                  <div className="flex gap-1">
                    <span className="bg-[var(--color-info-subtle)] text-[var(--color-info)] text-[9px] font-bold px-1.5 py-0.5 rounded">FB</span>
                    <span className="bg-[var(--color-error-subtle)] text-[var(--color-error)] text-[9px] font-bold px-1.5 py-0.5 rounded">TT</span>
                  </div>
                </div>
              ...
              <span className="text-[11px] font-bold text-[var(--color-text-muted)] bg-[var(--color-bg-surface-raised)] px-3 py-1.5 rounded-xl flex-shrink-0 w-fit">
                2 phút trước
              </span>
            </div>
            ...
            <div className="bg-[var(--color-bg-surface-raised)] rounded-xl p-3 md:p-4 mb-4 border border-[var(--color-border)] space-y-3">
              ...
              {[
                ...
                <div key={i} className="flex items-start gap-2.5">
                  <span className="material-symbols-outlined text-[var(--color-brand)] text-[16px] flex-shrink-0 mt-0.5">{item.icon}</span>
                  <p className="flex-1 text-xs text-[var(--color-text-primary)] font-medium line-clamp-1">{item.text}</p>
                  <a href="#" className="text-[var(--color-brand)] font-bold text-[10px] bg-[var(--color-brand-subtle)] px-2 py-0.5 rounded-lg flex-shrink-0 hover:bg-[var(--color-brand-border)] transition-colors">XEM</a>
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-3 border-t border-[var(--color-border)]">
              ...
              <div className="flex items-center gap-3 overflow-x-auto">
                {[
                  ...
                  <div key={ch.label} className={`flex items-center gap-1 flex-shrink-0 ${ch.ok ? 'text-[var(--color-success)]' : 'text-[var(--color-text-muted)] opacity-50'}`}>
              ...
              <div className="grid grid-cols-3 sm:flex gap-2">
                <button className="px-3 py-2.5 rounded-xl border border-[var(--color-border)] text-[11px] font-bold text-[var(--color-text-primary)] hover:bg-[var(--color-bg-surface-raised)] transition-all">
                  Xác nhận
                </button>
                <button className="px-3 py-2.5 rounded-xl border border-[var(--color-brand)]/30 text-[var(--color-brand)] text-[11px] font-bold hover:bg-[var(--color-brand-subtle)] transition-all">
                  Xu hướng
                </button>
                <button className="px-3 py-2.5 rounded-xl bg-[var(--color-brand)] text-white text-[11px] font-bold hover:bg-[var(--color-brand-hover)] active:scale-95 transition-all shadow-sm">
                  Giải quyết
                </button>
              </div>
            </div>
        ...
        <div className="glass-card rounded-2xl overflow-hidden border-l-4 border-amber-500 hover:shadow-lg transition-shadow">
          <div className="p-4 md:p-6">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
              <div className="space-y-2 flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="bg-[var(--color-warning)] text-white text-[9px] font-black px-2.5 py-1 rounded-lg uppercase tracking-widest">
                    ⚠️ HIGH
                  </span>
                  <span className="text-sm font-bold text-[var(--color-text-primary)]">Phúc Long Tea</span>
                  <span className="bg-[var(--color-error-subtle)] text-[var(--color-error)] text-[9px] font-bold px-1.5 py-0.5 rounded">TikTok</span>
                </div>
                <h2 className="text-base md:text-xl font-bold text-[var(--color-text-primary)] leading-snug">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-3 border-t border-[var(--color-border)]">
              ...
              <div className="grid grid-cols-2 sm:flex gap-2">
                <button className="px-4 py-2.5 rounded-xl border border-[var(--color-border)] text-[11px] font-bold text-[var(--color-text-primary)] hover:bg-[var(--color-bg-surface-raised)] transition-all">
                  Xác nhận
                </button>
                <button className="px-4 py-2.5 rounded-xl bg-[var(--color-brand)] text-white text-[11px] font-bold hover:bg-[var(--color-brand-hover)] active:scale-95 transition-all shadow-sm">
                  Giải quyết
                </button>
              </div>
            </div>
      ...
      <div className="pt-4">
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 border-t border-[var(--color-border)]">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button className="text-[10px] font-black text-[var(--color-brand)] border border-[var(--color-brand-border)] px-2.5 py-1 rounded-lg hover:bg-[var(--color-brand-subtle)] transition-colors">
                    + THÊM
                  </button>
                </div>
                <div className="flex flex-wrap gap-2">
                  {['Ngộ độc', 'Biểu tình', 'Tẩy chay', 'Chất lượng'].map((kw) => (
                    <span key={kw} className="inline-flex items-center gap-1.5 rounded-xl bg-[var(--color-bg-surface-raised)] px-3 py-1.5 text-xs font-bold border border-[var(--color-border)] shadow-sm text-[var(--color-text-primary)]">
                      {kw}
                      <span className="material-symbols-outlined text-[13px] cursor-pointer hover:text-[var(--color-error)] transition-colors">close</span>
                    </span>
                  ))}
                </div>
              </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-end gap-3">
          ...
          <button className="w-full sm:w-auto px-8 py-3 rounded-2xl font-bold text-sm bg-[var(--color-brand)] text-white shadow-lg hover:bg-[var(--color-brand-hover)] active:scale-95 transition-all order-1 sm:order-2">
            Lưu cấu hình
          </button>
        </div>
      </div>
