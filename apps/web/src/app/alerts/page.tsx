            ...
            <div className="space-y-3 pt-1">
              ...
              {trendingTags.map((tag, i) => (
                <button
                  ...
                  className={`w-full p-3 rounded-xl flex items-center justify-between transition-all cursor-pointer hover:scale-[1.02] hover:shadow-md active:scale-[0.99] text-left ${
                      ...
                      >
                        <div className="flex items-center gap-1.5 mb-1">
                          <span className={`text-[9px] font-black px-1.5 py-0.5 rounded-full ${
                            a.severity?.toLowerCase() === "critical" ? "bg-red-100 text-red-600" :
