  ...
  return (
    <div className={`flex flex-wrap gap-2 items-center ${compact ? 'mt-1' : 'mt-2'}`}>
      ...
      >
        ...
        <option value="warm" className="bg-yellow-50 dark:bg-yellow-950/50 text-yellow-800 dark:text-yellow-300" title="Quan tâm vừa, đang tìm hiểu hoặc cân nhắc">🟡 Warm</option>
