  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row w-full bg-gradient-to-br from-[#F5F3FF] to-white dark:from-[#13141f] dark:to-[#0B0B13] rounded-[24px] shadow-[0_20px_40px_rgba(109,94,246,0.06)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.5)] overflow-hidden min-h-[600px] border border-transparent dark:border-white/5">
      ...
      <div className="lg:w-[55%] p-8 lg:p-12 xl:p-14 flex flex-col justify-center relative">
        ...
        >
          {/* Badge */}
          <div className="inline-flex items-center gap-2 rounded-full bg-white/60 dark:bg-white/10 border border-[#ECE9FF] dark:border-white/10 px-4 py-2 text-[13px] font-bold text-[#6D5EF6] dark:text-[#8E83FA] shadow-sm mb-6 backdrop-blur-md">
            ✨ Trải nghiệm nền tảng quản trị thương hiệu bằng AI
          </div>
          
          <h2 className="font-display text-[32px] sm:text-[36px] xl:text-[44px] font-extrabold text-[#1B1B4A] dark:text-white leading-[1.15] tracking-tight mb-4 lg:mb-5">
            Biến dữ liệu thành quyết định <span className="text-[#6D5EF6] dark:text-[#8E83FA]">nhanh hơn.</span>
          </h2>
          
          <p className="text-[#4F5577] dark:text-gray-300 text-[15px] sm:text-[16px] leading-[1.6] max-w-[480px] mb-6 lg:mb-8">
          ...
          <div className="flex flex-col gap-3 mb-8 lg:mb-10">
            {[
              ...
              <div key={idx} className="flex items-center gap-4 bg-white/40 dark:bg-white/5 border border-white/60 dark:border-white/10 rounded-2xl p-4 shadow-sm backdrop-blur-sm transition-transform hover:translate-x-1 duration-300">
                <div className="w-10 h-10 rounded-[12px] flex items-center justify-center bg-[#6D5EF6]/10 dark:bg-[#6D5EF6]/20">
                  <item.icon className="w-5 h-5 text-[#6D5EF6] dark:text-[#8E83FA]" />
                </div>
                <span className="font-bold text-[#1B1B4A] dark:text-gray-100 text-[15px]">{item.text}</span>
              </div>
            ))}
          </div>

          {/* Social Proof */}
          <div className="flex flex-wrap items-center gap-4 pt-6 border-t border-[#ECE9FF] dark:border-white/10">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-10 h-10 rounded-full border-[2px] border-white dark:border-[#13141f] bg-slate-200 overflow-hidden relative shadow-sm">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1">
                ...
                <span className="font-bold text-[#1B1B4A] dark:text-white ml-1 text-[14px]">4.9/5</span>
              </div>
              <span className="text-[13px] text-[#6B7090] dark:text-gray-400 font-medium mt-0.5">Hơn 300 doanh nghiệp đang sử dụng</span>
            </div>
          </div>
        </motion.div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-5">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[13px] font-bold text-[#1B1B4A] dark:text-gray-200">Họ và tên <span className="text-red-500">*</span></label>
                <div className="relative group">
                  <div className={`absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none transition-colors ${errors.fullName ? "text-red-500" : "text-[#9CA3AF] dark:text-gray-500 group-focus-within:text-[#6D5EF6] dark:group-focus-within:text-[#8E83FA]"}`}>
                    <User className="h-[18px] w-[18px]" />
                  </div>
                  <input
                    type="text"
                    placeholder="Nguyễn Văn A"
                    className={`w-full h-[52px] rounded-[14px] border bg-[#FAFAFA] dark:bg-[#1B1C2A] text-black dark:text-white pl-[42px] pr-4 text-[14px] outline-none transition-all hover:bg-white dark:hover:bg-[#1F202E] focus:bg-white dark:focus:bg-[#1F202E] shadow-sm ${errors.fullName ? "border-red-500 focus:ring-[3px] focus:ring-red-500/15" : "border-gray-200 dark:border-white/10 focus:border-[#6D5EF6] dark:focus:border-[#8E83FA] focus:ring-[3px] focus:ring-[#6D5EF6]/15 hover:border-gray-300 dark:hover:border-white/20"}`}
              ...
              {/* Email */}
              <div className="flex flex-col gap-1.5">
                <label className="text-[13px] font-bold text-[#1B1B4A] dark:text-gray-200">Email công việc <span className="text-red-500">*</span></label>
                <div className="relative group">
                  <div className={`absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none transition-colors ${errors.email ? "text-red-500" : "text-[#9CA3AF] dark:text-gray-500 group-focus-within:text-[#6D5EF6] dark:group-focus-within:text-[#8E83FA]"}`}>
                    <Mail className="h-[18px] w-[18px]" />
                  </div>
                  <input
                    type="email"
                    placeholder="name@company.com"
                    className={`w-full h-[52px] rounded-[14px] border bg-[#FAFAFA] dark:bg-[#1B1C2A] text-black dark:text-white pl-[42px] pr-4 text-[14px] outline-none transition-all hover:bg-white dark:hover:bg-[#1F202E] focus:bg-white dark:focus:bg-[#1F202E] shadow-sm ${errors.email ? "border-red-500 focus:ring-[3px] focus:ring-red-500/15" : "border-gray-200 dark:border-white/10 focus:border-[#6D5EF6] dark:focus:border-[#8E83FA] focus:ring-[3px] focus:ring-[#6D5EF6]/15 hover:border-gray-300 dark:hover:border-white/20"}`}
              ...
              {/* Số điện thoại */}
              <div className="flex flex-col gap-1.5">
                <label className="text-[13px] font-bold text-[#1B1B4A] dark:text-gray-200">Số điện thoại <span className="text-red-500">*</span></label>
                <div className="relative group">
                  <div className={`absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none transition-colors ${errors.phone ? "text-red-500" : "text-[#9CA3AF] dark:text-gray-500 group-focus-within:text-[#6D5EF6] dark:group-focus-within:text-[#8E83FA]"}`}>
                    <Phone className="h-[18px] w-[18px]" />
                  </div>
                  <input
                    type="tel"
                    placeholder="090..."
                    className={`w-full h-[52px] rounded-[14px] border bg-[#FAFAFA] dark:bg-[#1B1C2A] text-black dark:text-white pl-[42px] pr-4 text-[14px] outline-none transition-all hover:bg-white dark:hover:bg-[#1F202E] focus:bg-white dark:focus:bg-[#1F202E] shadow-sm ${errors.phone ? "border-red-500 focus:ring-[3px] focus:ring-red-500/15" : "border-gray-200 dark:border-white/10 focus:border-[#6D5EF6] dark:focus:border-[#8E83FA] focus:ring-[3px] focus:ring-[#6D5EF6]/15 hover:border-gray-300 dark:hover:border-white/20"}`}
            ...
            {/* Trust Badges */}
            <div className="flex flex-col gap-2 pt-5 mt-1 border-t border-[#F1F0F5] dark:border-white/10">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-2">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-2">
                    ...
                    <span className="text-[12px] font-medium text-[#6B7090] dark:text-gray-400 leading-tight">{badge.text}</span>
                  </div>
                ))}
              </div>
            </div>
