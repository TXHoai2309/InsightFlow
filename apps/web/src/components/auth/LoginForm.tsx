        ...
        >
          ...
          <div className="mb-8">
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 border py-3 rounded-lg transition-all active:scale-95 ${isDark ? "border-gray-600 bg-gray-800 hover:bg-gray-700 text-white" : "border-[#c7c4d7] bg-[#f9f9ff] hover:bg-[#f0f3ff] text-[#111c2d]"}`}
            >
              ...
              <span className="text-[14px] font-medium">{t("auth.login.googleBtn")}</span>
            </button>
          </div>

          {/* Divider */}
          <div className="relative mb-8 flex items-center">
            <div className={`flex-grow border-t ${isDark ? "border-gray-600" : "border-[#c7c4d7]"}`} />
            <span className={`mx-4 text-[12px] font-medium uppercase tracking-widest ${isDark ? "text-gray-400" : "text-[#767586]"}`}>{t("auth.login.orLoginWith")}</span>
            <div className={`flex-grow border-t ${isDark ? "border-gray-600" : "border-[#c7c4d7]"}`} />
          </div>
          ...
          <footer className="mt-12 text-center">
            ...
            <p className={`text-[14px] ${isDark ? "text-gray-300" : "text-[#464554]"}`}>
