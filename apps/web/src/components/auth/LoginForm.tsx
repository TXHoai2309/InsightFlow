      ...
      <main className="w-full max-w-[480px] z-10">
        ...
        >
          <header className="mb-8">
            <h1 className="font-['Hanken_Grotesk'] text-[32px] leading-[40px] font-bold tracking-[-0.02em] text-[#111c2d] mb-2">{t("auth.login.welcome")}</h1>
            <p className="text-[16px] text-[#464554]">{t("auth.login.subtitle")}</p>
          </header>
          ...
          <div className="mb-8">
            ...
            >
              ...
              <span className="text-[14px] font-medium text-[#111c2d]">{t("auth.login.googleBtn")}</span>
            </button>
          </div>
          ...
          <div className="relative mb-8 flex items-center">
            ...
            <span className="mx-4 text-[12px] font-medium text-[#767586] uppercase tracking-widest">{t("auth.login.orLoginWith")}</span>
            <div className="flex-grow border-t border-[#c7c4d7]" />
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-6">
            ...
            <div className="space-y-1">
              <label htmlFor="email" className="text-[14px] font-medium text-[#464554] px-1">{t("auth.login.emailLabel")}</label>
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center px-1">
                <label htmlFor="password" className="text-[14px] font-medium text-[#464554]">{t("auth.login.passwordLabel")}</label>
          ...
          <footer className="mt-12 text-center">
            ...
            <p className="text-[14px] text-[#464554]">
              ...
              <Link href="/register" className="text-[#4648d4] font-semibold hover:underline">{t("auth.login.registerNow")}</Link>
            </p>
          </footer>
        </div>
        ...
        <div className="mt-8 flex items-center justify-between px-4 py-2 bg-[#f0f3ff] rounded-full border border-[#c7c4d7]/30">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[12px] font-medium text-[#464554]">{t("auth.system.statusNormal")}</span>
          </div>
