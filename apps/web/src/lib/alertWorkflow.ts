export type AlertWorkflowStatus = "pending" | "processing" | "contact_failed" | "resolved";
...
/**
 * The crisis workflow has exactly three business states. Legacy statuses are
 * normalized here so every screen uses the same rule.
 */
...
export function getPersistedAlertStatus(alert: AlertStatusSource): "new" | "resolving" | "contact_waiting" | "contact_failed" | "resolved" {
