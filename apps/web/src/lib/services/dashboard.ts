...
function supabasePostToMention(row: SupabaseRow, annotationByKey: Map<string, SupabaseRow>): Mention {
  ...
  return {
    ...
    url: normalizeOptionalUrl(row.url, payload.url),
    ...
    source_url: normalizeOptionalUrl(payload.source_url, payload.original_url, payload.permalink),
...
function supabaseCommentToMention(
  ...
  return {
    ...
    url: normalizeOptionalUrl(
      ...
      payload.url,
      payload.comment_url,
      payload.source_comment_url,
      payload.original_comment_url,
    ),
